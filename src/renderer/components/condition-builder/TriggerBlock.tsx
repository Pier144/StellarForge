// src/renderer/components/condition-builder/TriggerBlock.tsx
// Visual component for trigger blocks (blue).
...
export function TriggerBlock({ block, onDelete, onUpdate, children }: Props) {
  return (
    <div
